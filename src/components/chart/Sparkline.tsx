...
/**
 * Inline 13-week trajectory. Y domain is per-account so shape stays visible.
 * The path stays neutral ink in every row; vermilion is reserved for the
 * final-reading marker on accounts in real drawdown, so alarm reads as signal.
 */
